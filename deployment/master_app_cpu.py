...
class MasterApp:
    ...
    def build_susceptibility_ui(self, parent):
        ...
        self.add_combo(tab_sweep, "susc_solver_choice", "Solver", ["cpu"], "cpu")
        ...
        self.add_combo(tab_phase, "susc_solver_phase", "Solver", ["cpu"], "cpu")
    ...
    def build_self_energy_ui(self, parent):
        ...
        self.add_combo(tab_sweep, "se_solver_choice", "Solver", ["cpu"], "cpu")
